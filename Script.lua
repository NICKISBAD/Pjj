...
local win = DiscordLib:Window("Jiver's Project Jojo REVAMPED")
...
btns:Toggle("AutoFarm (Morioh)",false, function(value)
...
btns:Toggle("Worthiness Farm (Italy)", false, function(value)
	wfi = value
	local plr = game.Players.LocalPlayer.Character
...
btns:Toggle("Money Farm (Italy)",false,function(value)
	mfi = value
	local plr = game.Players.LocalPlayer.Character
...
btns:Toggle("Money Farm (Morioh)", false, function(value)
